...
#set the name of the data file without extension, for example, data from data.dat
datafile=alarm_10000
...
./balestasis 0 $psiTime $soTime ./log/$datafile.txt ./data/$datafile.dat 'm' $restart None $saveNet ./network/$datafile.dsc
